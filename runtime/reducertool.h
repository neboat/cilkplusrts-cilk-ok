...
void __attribute__((weak)) cilk_begin_reduce_strand(void);
void __attribute__((weak)) cilk_end_reduce_strand(void);
void __attribute__((weak)) cilk_begin_update_strand(void);
void __attribute__((weak)) cilk_end_update_strand(void);

void __attribute__((weak)) cilk_set_reducer(void *reducer, void *rip, const char *function, int line);
void __attribute__((weak)) cilk_read_reducer(void *reducer, void *rip, const char *function, int line);
...
#endif  // INCLUDED_REDUCERTOOL_DOT_H
